...
git clone <git@github.com>:USER/goph457-w2025-MT01-stOJ.git
If you do not have an SSH key setup, you can use:
git clone <https://github.com/USER/goph457-w2025-MT01-stOJ.git>
and you may need to enter your GitHub password.
If you installed the GitHub CLI, you can use:
gh repo clone USER/goph457-w2025-MT01-stOJ.git.
4. You should now have a directory called goph457-w2025-MT01-stOJ.git,
